...
RSpec.describe 'project show', type: :feature do
  describe 'As a visitor' do
    ...
    # User Story 3 of 3
    it "displays number of contestants" do 
      recycled_material_challenge = Challenge.create(theme: "Recycled Material", project_budget: 1000)
      furniture_challenge = Challenge.create(theme: "Apartment Furnishings", project_budget: 1000)
      ...
      expect(page).to have_content("Contestants on this project: 0")
    end

    # User Story Extension 1 - Average years of experience for contestants by project
    it "can display average exp" do 
      recycled_material_challenge = Challenge.create(theme: "Recycled Material", project_budget: 1000)
      furniture_challenge = Challenge.create(theme: "Apartment Furnishings", project_budget: 1000)
      ...
      expect(page).to have_content("Average Contestant Exp: 10 years")
    end

    # User Story Extension 2 - Adding a contestant to a project
    it "can add contestants to projects" do 
      recycled_material_challenge = Challenge.create(theme: "Recycled Material", project_budget: 1000)
      furniture_challenge = Challenge.create(theme: "Apartment Furnishings", project_budget: 1000)
